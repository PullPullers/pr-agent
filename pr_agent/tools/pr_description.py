...
"""
            ...
            if counter_extra_files > 0:
                ...
                if (
                    ...
                    if "pr_files" in original_prediction_dict:
                        ...
                        original_prediction_dict["pr_files"] = prediction_extra_dict[
                            "pr_files"
                        ]
            ...
            get_logger().exception(
                f"Error extending uncovered files {self.pr_id}", artifact={"error": e}
            )
